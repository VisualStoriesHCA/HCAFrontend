...
import { TextLoadingSpinner } from "./CustomLoadingSpinners";
  ...
  return (
    <div className={`relative flex flex-col min-h-0 ${className}`}>
      {adjusting && (
        <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30 z-10">
          <div className="flex items-center">
            <TextLoadingSpinner size="lg" className="text-white" />
      ...
      <div
        ...
        className="flex-1 p-4 w-full min-h-0 resize-none border focus:outline-none whitespace-pre-wrap overflow-y-auto bg-white rounded-md"
